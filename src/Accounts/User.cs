...
public class User
{
    ...
    public int CalcMaxT2ISimultaneous => Math.Max(1, Math.Min(CalculatedRole.Data.MaxT2ISimultaneous, Program.ServerSettings.Backends.UnrestrictedMaxT2iSimultaneous ? int.MaxValue : BackendHandler.Instance.RunningBackendsOfType<AbstractT2IBackend>().Sum(b => b.MaxUsages) * 2));
